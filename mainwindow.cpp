...
//			// DBEMpresa
//            //splash.showMessage(tr("Cargando configuración de base de datos") );
...
//			//DBMedica
//            //splash.showMessage(tr("Cargando configuración médica") );
...
//			// Varios
//            //splash.showMessage(tr("Cargando configuración financiera") );
...
//			// Abro empresa activa
//            //splash.showMessage(tr("Cargando datos de la empresa activa") );
...
//            //splash.showMessage(tr("Abriendo base de datos médica") );
