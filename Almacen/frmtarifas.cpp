...
{
    if(QMessageBox::question(this,tr("Gestión de artículos"),tr("Se ha cambiado el coste del producto,\n¿desea actualizar las tarifas?"),
                             tr("No"),tr("Sí"))== QMessageBox::Accepted){
            // TODO repasar tarifas para actualizar precios
