...
CREATE  TABLE IF NOT EXISTS `@grupo@`.`codigotarifa` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `descripcion` VARCHAR(45) NULL DEFAULT NULL ,
  `codigo_tarifa` VARCHAR(4) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `@grupo@`.`empresas` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,   `codigo` VARCHAR(10) NULL DEFAULT NULL ,   `nombre` VARCHAR(75) NULL DEFAULT NULL ,   `digitos_factura` INT(11) NULL DEFAULT NULL ,   `serie` INT(11) NULL DEFAULT NULL ,   `ruta_bd_sqlite` TEXT NULL DEFAULT NULL ,   `ruta_db_conta` TEXT NULL DEFAULT NULL ,   `ruta_bd_medicasqlite` TEXT NULL DEFAULT NULL ,   `nombre_bd` VARCHAR(50) NULL DEFAULT NULL ,   `nombre_db_conta` VARCHAR(100) NULL DEFAULT NULL ,   `nombre_bd_medica` VARCHAR(45) NULL DEFAULT NULL ,   `direccion` VARCHAR(150) NULL DEFAULT NULL ,   `cp` VARCHAR(8) NULL DEFAULT NULL ,   `poblacion` VARCHAR(60) NULL DEFAULT NULL ,   `provincia` VARCHAR(50) NULL DEFAULT NULL ,   `pais` VARCHAR(40) NULL DEFAULT NULL ,   `telefono1` VARCHAR(20) NULL DEFAULT NULL ,   `telefono2` VARCHAR(20) NULL DEFAULT NULL ,   `fax` VARCHAR(20) NULL DEFAULT NULL ,   `mail` TEXT NULL DEFAULT NULL ,   `web` TEXT NULL DEFAULT NULL ,   `cif` VARCHAR(25) NULL DEFAULT NULL ,   `inscripcion` TEXT NULL DEFAULT NULL ,   `comentario_albaran` TEXT NULL DEFAULT NULL ,   `comentario_factura` TEXT NULL DEFAULT NULL ,   `comentario_ticket` TEXT NULL DEFAULT NULL ,   `ejercicio` INT(11) NULL DEFAULT NULL ,   `usar_irpf` INT(11) NULL DEFAULT NULL ,   `codigo_cuenta_clientes` VARCHAR(25) NULL DEFAULT NULL ,   `codigo_cuenta_proveedores` VARCHAR(25) NULL DEFAULT NULL ,   `codigo_cuenta_acreedores` VARCHAR(25) NULL DEFAULT NULL ,   `digitos_cuenta` INT(11) NULL DEFAULT NULL ,   `clave1` TEXT NULL DEFAULT NULL ,   `clave2` TEXT NULL DEFAULT NULL ,   `medica` INT(11) NULL DEFAULT NULL ,   `internacional` INT(11) NULL DEFAULT NULL ,   `auto_codigo` TINYINT(1) NULL DEFAULT NULL ,   `tamanocodigo` INT(11) NULL DEFAULT NULL ,   `cuenta_cobros` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_pagos` VARCHAR(45) NULL DEFAULT NULL ,   `id_divisa` INT(11) NULL DEFAULT NULL ,   `enlaceweb` TINYINT(1) NULL DEFAULT NULL ,   `contabilidad` TINYINT(1) NULL DEFAULT NULL ,   `consultas` INT(11) NULL DEFAULT NULL ,   `primer_dia_laborable` VARCHAR(45) NULL DEFAULT NULL ,   `ultimo_dia_laborable` VARCHAR(45) NULL DEFAULT NULL ,   `horario_primer_dia` VARCHAR(45) NULL DEFAULT NULL ,   `horario_dia_normal` VARCHAR(45) NULL DEFAULT NULL ,   `horario_ultimo_dia` VARCHAR(45) NULL DEFAULT NULL ,   `ticket_factura` TINYINT(1) NULL DEFAULT NULL ,   `margen` DOUBLE NULL DEFAULT NULL ,   `margen_minimo` DOUBLE NULL DEFAULT NULL ,   `seguimiento` TINYINT(1) NULL DEFAULT NULL ,   `id_tarifa_predeterminada` INT(11) NULL DEFAULT NULL ,   `actualizardivisas` TINYINT(1) NULL DEFAULT NULL ,   `cuenta_ventas_mercaderias` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_ventas_servicios` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado1` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado2` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado3` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado4` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido1` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido2` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido3` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido4` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido1_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido2_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido3_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_repercutido4_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado1_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado2_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado3_re` VARCHAR(45) NULL DEFAULT NULL ,   `cuenta_iva_soportado4_re` VARCHAR(45) NULL DEFAULT NULL ,   PRIMARY KEY (`id`) ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARACTER SET = utf8;
