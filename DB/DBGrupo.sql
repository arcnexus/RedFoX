...
CREATE  TABLE IF NOT EXISTS `@grupo@`.`empresas` (
  `driver_bd_medica` VARCHAR(30) NULL DEFAULT NULL ,
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  `puerto` VARCHAR(8) NULL DEFAULT NULL ,
  `driver_bd` VARCHAR(50) NULL DEFAULT NULL ,
  ...
  `ruta_bd_medicasqlite` TEXT NULL DEFAULT NULL ,
  `host_bd_medica` VARCHAR(35) NULL DEFAULT NULL ,
  `user_bd_medica` VARCHAR(50) NULL DEFAULT NULL ,
  `contrasena_bd_medica` VARCHAR(45) NULL DEFAULT NULL ,
  `nombre_bd_medica` VARCHAR(45) NULL DEFAULT NULL ,
  `puerto_bd_medica` VARCHAR(10) NULL DEFAULT NULL ,
  ...
  `tamanocodigo` INT(11) NULL DEFAULT NULL ,
  `cuenta_cobros` VARCHAR(45) NULL DEFAULT NULL ,
  `cuenta_pagos` VARCHAR(45) NULL DEFAULT NULL ,
  `id_divisa` INT(11) NULL DEFAULT NULL ,
  `enlaceweb` TINYINT(1) NULL DEFAULT NULL ,
  `host_db_conta` VARCHAR(150) NULL DEFAULT NULL ,
  `nombre_db_conta` VARCHAR(100) NULL DEFAULT NULL ,
  `user_db_conta` VARCHAR(45) NULL DEFAULT NULL ,
  `password_db_conta` VARCHAR(45) NULL DEFAULT NULL ,
  `puerto_db_conta` VARCHAR(8) NULL DEFAULT NULL ,
  `driver_db_conta` VARCHAR(45) NULL DEFAULT NULL ,
  ...
  `actualizardivisas` TINYINT(1) NULL DEFAULT NULL ,
