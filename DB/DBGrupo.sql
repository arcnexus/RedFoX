...
CREATE  TABLE IF NOT EXISTS `@grupo@`.`articulos` (
  ...
  `unidades_compradas` FLOAT NULL DEFAULT '0' ,
  `unidades_vendidas` FLOAT NULL DEFAULT '0' ,
  ...
  `stock_maximo` FLOAT NULL DEFAULT '0' ,
  `stock_minimo` FLOAT NULL DEFAULT '0' ,
  `stock_real` FLOAT NULL DEFAULT '0' ,
  ...
  `pvp_incluye_iva` TINYINT(1) NULL DEFAULT '0' ,
  `fecha_prevista_recepcion` DATE NULL DEFAULT NULL ,
  `cantidad_pendiente_recibir` FLOAT NULL DEFAULT '0' ,
  `unidades_reservadas` FLOAT NULL DEFAULT '0' ,
  ...
  `stock_fisico_almacen` FLOAT NULL DEFAULT NULL ,
  ...
  `imagen3` BLOB NULL DEFAULT NULL ,
  `imagen4` BLOB NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `@grupo@`.`empresas` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,
  ...
  `tpv_forzar_cantidad` TINYINT(1) NULL DEFAULT '0' ,
  `caducidad_vales` INT NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) )
