...
CREATE  TABLE IF NOT EXISTS `@empresa@`.`acum_articulos` (
  ...
  `unid_comp_febrero` INT(11) NULL DEFAULT '0' ,
  `unid_comp_marzo` INT(11) NULL DEFAULT '0' ,
  `unid_comp_abril` INT(11) NULL DEFAULT '0' ,
  `unid_comp_mayo` INT(11) NULL DEFAULT '0' ,
  `unid_comp_junio` INT(11) NULL DEFAULT '0' ,
  `unid_comp_julio` INT(11) NULL DEFAULT '0' ,
  `unid_comp_agosto` INT(11) NULL DEFAULT '0' ,
  `unid_comp_septiembre` INT(11) NULL DEFAULT '0' ,
  `unid_comp_octubre` INT(11) NULL DEFAULT '0' ,
  `unid_comp_noviembre` INT(11) NULL DEFAULT '0' ,
  `unid_comp_diciembre` INT(11) NULL DEFAULT '0' ,
  `unid_comp_ejercicio` INT(11) NULL DEFAULT '0' ,
  `acum_comp_enero` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_febrero` DOUBLE NULL DEFAULT '0',
  `acum_comp_marzo` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_abril` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_mayo` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_junio` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_julio` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_agosto` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_septiembre` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_octubre` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_noviembre` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_diciembre` DOUBLE NULL DEFAULT '0' ,
  `acum_comp_ejercicio` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_enero` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_febrero` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_marzo` DOUBLE NULL DEFAULT '0',
  `unid_vent_abril` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_mayo` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_junio` DOUBLE NULL DEFAULT '0',
  `unid_vent_julio` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_agosto` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_septiembre` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_octubre` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_noviembre` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_diciembre` DOUBLE NULL DEFAULT '0' ,
  `unid_vent_acumulado` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_enero` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_febrero` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_marzo` DOUBLE NULL DEFAULT '0',
  `acum_vent_abril` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_mayo` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_junio` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_julio` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_agosto` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_septiembre` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_octubre` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_noviembre` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_diciembre` DOUBLE NULL DEFAULT '0' ,
  `acum_vent_ejercicio` DOUBLE NULL DEFAULT '0',
...
CREATE  TABLE IF NOT EXISTS `@empresa@`.`alb_pro` (
  ...
  `porc_iva_gasto1` FLOAT NULL DEFAULT '0' ,
  `porc_iva_gasto2` FLOAT NULL DEFAULT '0' ,
  `porc_iva_gasto3` FLOAT NULL DEFAULT '0' ,
  `iva_gasto1` FLOAT NULL DEFAULT '0' ,
...
CREATE  TABLE IF NOT EXISTS `@empresa@`.`cab_alb` (
  ...
  `id_pais` INT(11) NULL DEFAULT NULL ,
  `direccion1_entrega` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,
  `direccion2_entrega` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `@empresa@`.`cab_tpv` (
  ...
  `fecha` DATE NOT NULL ,
  `hora` VARCHAR(30) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL ,
  ...
  `importe_domiciliacion` DOUBLE NULL DEFAULT '0' ,
  `importe_transferencia` DOUBLE NULL DEFAULT '0' ,
  `importe_vale` DOUBLE NULL DEFAULT NULL ,
  `importe_dto_redondeo` DOUBLE NULL DEFAULT '0' ,
  `importe_cambio` DOUBLE NULL DEFAULT '0' ,
  `entregado_a_cuenta` DOUBLE NULL DEFAULT '0' ,
  `numero_pedido` INT(11) NULL DEFAULT '0' ,
...
CREATE  TABLE IF NOT EXISTS `@empresa@`.`ped_cli` (
  ...
  `subtotal` DOUBLE NULL DEFAULT '0' ,
  `porc_dto` FLOAT NULL DEFAULT '0' ,
  `porc_dto_pp` DOUBLE NULL DEFAULT '0' ,
  `dto_pp` DOUBLE NULL DEFAULT '0' ,
  `dto` DOUBLE NULL DEFAULT '0' ,
  `base1` DOUBLE NULL DEFAULT '0' ,
  `base2` DOUBLE NULL DEFAULT '0' ,
