...
void FrmAlbaran::LLenarCampos()
{
    ...
    ui->txtporc_rec1->setText(QString::number(oAlbaran->porc_rec1,'f',Configuracion_global->decimales));
    ui->txtporc_rec2->setText(QString::number(oAlbaran->porc_rec2,'f',Configuracion_global->decimales));
    ui->txtporc_rec3->setText(QString::number(oAlbaran->porc_rec3,'f',Configuracion_global->decimales));
    ui->txtporc_rec4->setText(QString::number(oAlbaran->porc_rec4,'f',Configuracion_global->decimales));
    ui->txtrec1->setText(Configuracion_global->toFormatoMoneda(QString::number(oAlbaran->rec1,'f',Configuracion_global->decimales)));
    ui->txtrec2->setText(Configuracion_global->toFormatoMoneda(QString::number(oAlbaran->rec2,'f',Configuracion_global->decimales)));
    ui->txtrec3->setText(Configuracion_global->toFormatoMoneda(QString::number(oAlbaran->rec3,'f',Configuracion_global->decimales)));
    ui->txtrec4->setText(Configuracion_global->toFormatoMoneda(QString::number(oAlbaran->rec4,'f',Configuracion_global->decimales)));
...
void FrmAlbaran::LLenarAlbaran()
{
    ...
    oAlbaran->porc_rec1= ui->txtporc_rec1->text().toDouble();
    oAlbaran->porc_rec2= ui->txtporc_rec2->text().toDouble();;
    oAlbaran->porc_rec3= ui->txtporc_rec3->text().toDouble();;
    oAlbaran->porc_rec4= ui->txtporc_rec4->text().toDouble();;
    oAlbaran->rec1= (Configuracion_global->MonedatoDouble(ui->txtrec1->text()));
    oAlbaran->rec2= (Configuracion_global->MonedatoDouble(ui->txtrec2->text()));
    oAlbaran->rec3= (Configuracion_global->MonedatoDouble(ui->txtrec3->text()));
    oAlbaran->rec4= (Configuracion_global->MonedatoDouble(ui->txtrec4->text()));
